...
<head>
	<title> <?php echo $_REQUEST['category']; ?> |NEWS</title>
						...
						<div class="block-content">
							...
							<div class="grid-box">
								<div class="title-section">
									<h1><span class="world"><?php echo $_REQUEST['category']; ?> ~ Archive</span></h1>
								</div>  

								<div class="row">
								<?php
            $sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM `newsupdate` WHERE category='$_REQUEST[category]'  ORDER BY `id` DESC LIMIT 0, 20";
            $result = mysqli_query($conn, $sql);
									...
									<div class="col-md-6">
										<div class="news-post standard-post2">
											...
											<a <?php echo "href='news.php?a=" . $row['a'] . "' "; ?>><img src="dashboard/newscoverphoto/<?php echo $row['newscoverimage'] ?>"></a>
												<a class="category-post travel" href="news.php?category=<?php echo $row['category']; ?>"><?php echo $row['category']; ?></a>
											</div>
